...
module Middleman
  class Application
    ...
    # Name of the shared project directory
    # @return [String]
    config.define_setting :shared,      'shared', 'Name of the shared project directory'
    ...
    # The full path to the shared project
    #
    # @return [String]
    def shared_root
    ...
    def shared_source_dir
      File.join(shared_root, config[:source])
    end
